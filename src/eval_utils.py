...
def is_nc(score, data_size, threshold):
    if score[1] + score[3] == data_size and score[1] > threshold:
        return True
    else:
        return False
...
def is_sc(score, data_size, threshold):
    if score[0] + score[1] == data_size and score[1] > threshold:
        return True
    else:
        return False
...
def is_sc_th_good(score, data_size, threshold):
    if (score[0] + score[1]) / data_size > threshold:
        return True
    else:
        return False
...
def is_uc_th_good(score, threshold):
    if score[0] / score[1] < threshold and score[2] / score[1] < threshold and score[3] / score[1] < threshold:
        return True
    else:
        return False
